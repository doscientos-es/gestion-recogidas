...
const compactMontaxEmail = `TRANSFER MONTAX, S.L. Apreciado colaborador, Tras su aceptación, procedemos a indicarle los datos completos del servicio a realizar: *OBSERVACIONES PARA EL CONDUCTOR:* *DATOS DE LA RESERVA:* ○ ID SERVICIO: 12345 ○ TIPO SERVICIO: SERVICIO CON ESPERA Y VUELTA ○ FECHA DEL SERVICIO: 12/09/2026 ○ HORA DEL SERVICIO:14:00 ○ NOMBRE Y APELLIDOS:Gerard Martinez Alcocer ○ TELÉFONO: 685282020 ○ Nº PAX: 2 ○ MALETERO: 2 Maletas TRAYECTOS: ○TRAYECTO 1: ○ ORIGEN: Can pou 12, Premia de mar ○ DESTINO: Calle herrero 83, Castellón de la plana LUGAR DE DESTINO/INSTRUCCIONES: PRINCIPAL ○ TIEMPO ESPERA PREVISTO: 3h ○TRAYECTO 2: ○ ORIGEN:Calle herrero 83, Castellón de la plana LUGAR DE ORIGEN/INSTRUCCIONES: YA REALIZADO ○ DESTINO: Can pou 12, Premia de mar *EXTRAS:* *PREFERENCIAS PERSONALES DEL USUARIO:* ○ IDIOMA: PREFERENTE: CATALÁN *PRECIO SERVICIO EUR (IVA INCL.):* ○ HORAS DE ESPERA: 2h ○ PRECIO HORAS ESPERA (EUR/HORA): 12 ○ IMPORTE HORAS ESPERA: 24 ○ IMPORTE TRAYECTO/S: 500 ○ IMPORTE EXTRAS: 0,00 ○ IMPORTE TOTAL DEL SERVICIO: 524 *REFERENTE A LAS HORAS DE ESPERA:* ○ LAS HORAS DE ESPERA SE CONTABILIZAN DESDE LA HORA DE LLEGADA AL HOSPITAL HASTA LA SALIDA DEL MISMO. ○ CUANDO EL IMPORTE TOTAL DE LAS HORAS DE ESPERA SUPERE EL IMPORTE DE COMPRA DEL SERVICIO, SE FACTURARÁ DOBLE TRAYECTO. ○ CUANDO FINALICE EL SERVICIO DEBE INFORMARNOS DE LAS HORAS DE ESPERA POR EMAIL O POR TELÉFONO. ○ LAS HORAS DE ESPERA QUE NO SE COMUNIQUEN ANTES DE LAS *XX* HORAS DEL MISMO DIA DEL CIERRE DEL TRASLADO PODRÁN SER NO FACTURADAS. SI NO NOS INFORMA ENTENDEREMOS QUE NO HA HABIDO TIEMPO DE ESPERA Y POR LO TANTO SOLO SE FACTURARÁ EL TRAYECTO DE IDA.`
